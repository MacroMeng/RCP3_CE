def exitwindow():
    ...
    exit_window.blit(
        asktext,
        (
            int((exit_window.get_width() - asktext.get_width()) / 2),
            int(20 * k),
        ),
    )
    pygame.draw.rect(
        exit_window,
        (63, 63, 63, buttonalpha),
    ...
    exit_window.blit(
        text_1,
        (
            int(40 * k + (110 * k - text_1.get_width()) / 2),
            int(130 * k + (33 * k - text_1.get_height()) / 2),
        ),
    )
    pygame.draw.rect(
        exit_window,
    ...
    exit_window.blit(
        text_2,
        (
            int(175 * k + (110 * k - text_2.get_width()) / 2),
            int(130 * k + (33 * k - text_2.get_height()) / 2),
        ),
    )
    pygame.draw.rect(
        exit_window,
    ...
    exit_window.blit(
        text_3,
        (
            int(310 * k + (110 * k - text_3.get_width()) / 2),
            int(130 * k + (33 * k - text_3.get_height()) / 2),
        ),
    )
    screen.blit(
        exit_window,
        (
            int((screen.get_width() - 480 * k) / 2),
            int((screen.get_height() - 180 * k) / 2),
        ),
    )
    pygame.display.flip()
    a = 0
    while a == 0:
        tempsurface2 = pygame.Surface(
            (screen.get_width(), screen.get_height()), SRCALPHA
        )
        screen.blit(screen_surface, (0, 0))
        screen.blit(mask, (0, 0))
        ...
        if pygame.Rect(
            int((screen.get_width() - 480 * k) / 2 + 40 * k),
            int((screen.get_height() - 180 * k) / 2 + 130 * k),
            110 * k,
            33 * k,
            ...
            int((screen.get_width() - 480 * k) / 2 + 40 * k + 135 * k),
            int((screen.get_height() - 180 * k) / 2 + 130 * k),
            110 * k,
            33 * k,
        ).collidepoint(pygame.mouse.get_pos()):
            ...
            int((screen.get_width() - 480 * k) / 2 + 40 * k + 270 * k),
            int((screen.get_height() - 180 * k) / 2 + 130 * k),
            110 * k,
            33 * k,
        ).collidepoint(pygame.mouse.get_pos()):
            ...
            match event.type:
                    ...
                    if pygame.Rect(
                        ...
                        while b == 0:
                            ...
                            pygame.draw.rect(
                                ...
                                (
                                    int(
                                        (screen.get_width() - 480 * k) / 2
                                        + 40 * k
                                    ),
                                    int(
                                        (screen.get_height() - 180 * k) / 2
                                        + 130 * k
                                    ),
                                    110 * k,
                                    33 * k,
                        ...
                        pygame.display.set_icon(
                            pygame.image.load('.\\images\\14.ico')
                        )
                        return
                    elif pygame.Rect(
                        int(
                ...
                case pygame.VIDEORESIZE:
                    for i in range(2):
                        ...
                        sizex = int(100 * k)
                        sizey = int(30 * k)
                        globals()['fullscreensurface'] = pygame.Surface(
                            (36 * k, 36 * k), SRCALPHA
                        )
                        showclock(flush=False)
                        draw_lastname(flush=False)
                        ...
                        if currentpage == 'settingsloop':
                            screensurface.blit(
                                ...
                                (
                                    (
                                        screen.get_width()
                                        - surfacemixer.get_width()
                                    )
                                    / 2,
                                    (
                                        screen.get_height()
                                        - surfacemixer.get_height()
                                    )
                                    / 2,
                                ),
                            )
                            screensurface.blit(
                                ...
                                (
                                    (
                                        screen.get_width()
                                        - tempsurface2.get_width()
                                    )
                                    / 2,
                                    (
                                        screen.get_height()
                                        - tempsurface2.get_height()
                                    )
                                    / 2,
                                ),
                            )
                        screensurface = pygame.display.get_surface()
                        screen_surface = pygame.Surface(
                            pygame.display.get_surface().get_size(), SRCALPHA
                        )
                        screen_surface.blit(screensurface, (0, 0))
                        globals()[
                            'fullscreenbutton_img'
                        ] = pygame.transform.smoothscale(
                            pygame.image.load(
                                '.\\images\\buttons\\fullscreen.png'
                            ),
                            (int(36 * k), int(36 * k)),
                        )
                        globals()[
                            'exitfullscreenbutton_img'
                        ] = pygame.transform.smoothscale(
                            pygame.image.load(
                                '.\\images\\buttons\\exitfullscreen.png'
                            ),
                            (int(36 * k), int(36 * k)),
                        )
                        ...
                        mask.fill((0, 0, 0, 150))
                        screen.blit(mask, (0, 0))
                        exit_window = pygame.Surface(
                            (int(480 * k), int(180 * k)), SRCALPHA
                        )
                        pygame.draw.rect(
                            exit_window,
                            (31, 31, 31, 245),
                        ...
                        exit_window.blit(
                            ...
                            (
                                int(
                                    40 * k + (110 * k - text_1.get_width()) / 2
                                ),
                                int(
                                    130 * k
                                    + (33 * k - text_1.get_height()) / 2
                                ),
                            ),
                        )
                        pygame.draw.rect(
                        ...
                        exit_window.blit(
                            ...
                            (
                                int(
                                    175 * k
                                    + (110 * k - text_2.get_width()) / 2
                                ),
                                int(
                                    130 * k
                                    + (33 * k - text_2.get_height()) / 2
                                ),
                            ),
                        )
                        pygame.draw.rect(
                        ...
                        exit_window.blit(
                            ...
                            (
                                int(
                                    310 * k
                                    + (110 * k - text_3.get_width()) / 2
                                ),
                                int(
                                    130 * k
                                    + (33 * k - text_3.get_height()) / 2
                                ),
                            ),
                        )
